...
export type DiscordRole = any;

export type DiscordEmoji = any;

export type DiscordGuildFeature = any;

export type DiscordVoiceState = any;
...
export type DiscordPresenceUpdate = any;
